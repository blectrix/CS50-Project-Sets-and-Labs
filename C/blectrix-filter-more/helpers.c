...
// Creating the blur effect that will be fetched when applying blur to an image
...
// Creating the sobel filter that will be fetched when applied to an image
